  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        // Shadow custom variants
        hero: "bg-gradient-to-r from-accent to-destructive text-accent-foreground hover:shadow-[0_0_30px_hsl(0,100%,43%,0.5)] hover:scale-105 font-semibold",
        heroOutline: "border-2 border-accent/60 bg-transparent text-foreground hover:border-accent hover:bg-accent/10 hover:shadow-[0_0_20px_hsl(0,100%,43%,0.3)] font-semibold",
        glass: "glass-card text-foreground hover:text-accent-foreground font-medium",
