...
import { Bell, Search, MessageSquare, Settings, Sun, Moon } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 glass-card border-b border-border/30 px-6 py-4">
      <div className="flex items-center justify-between">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="relative w-96">
          ...
          <Input placeholder="Search jobs, interviews, skills..." className="pl-10 bg-muted/20 border-border/30 focus:border-accent/50 focus:ring-accent/20" />
        </motion.div>
